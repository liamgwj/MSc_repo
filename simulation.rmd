...
At this point, we're ready to carry out the actual connectivity calculations using Omniscape/Julia. The commands for this are found in 'omni_connectivity.txt'.


```{r}
juliaUsing("Omniscape")

juliaCall("run_omniscape(\"/home/liam/Documents/MSc/Thesis/analysis/MSc_repo/omniscape/true_host.ini\"::String)")
```


```{r}
juliaCall("run_omniscape(\"/home/liam/Documents/MSc/Thesis/analysis/MSc_repo/omniscape/known_host.ini\"::String)")
```


```{r}
juliaCall("run_omniscape(\"/home/liam/Documents/MSc/Thesis/analysis/MSc_repo/omniscape/predicted_host.ini\"::String)")
```
