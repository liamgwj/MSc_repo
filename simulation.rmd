...
## Recalculate available habitat using reduced host list
```{r}
...
## Replot the phylogeny with non-host tips in black, "known" hosts in red and "unknown" hosts in blue... [add other categories...]
```{r fig.width=6, fig.height=8}
#tip_cols2 <- tip_cols
#tip_cols2[setdiff(host_indexes, known_host_indexes)] <- 4
#
